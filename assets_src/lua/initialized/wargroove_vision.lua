...
function WargrooveVision.init()
	...
	Original.updateFogOfWar = OldWargroove.updateFogOfWar
	OldWargroove.updateFogOfWar = WargrooveVision.updateFogOfWar
end
...
function WargrooveVision.updateFogOfWar(matchseed)
	Original.updateFogOfWar(matchseed)
	Corners.updateAll()
end
