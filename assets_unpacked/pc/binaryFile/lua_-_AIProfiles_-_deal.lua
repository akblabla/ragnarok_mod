...
local antiAirReluctance = 500;
local airThreatPerTower = 300;
local baseLineOpportunityCost = 0.9
local baseLineOpportunityCostScaling = 0.9
local unitRatioResetPerUnit = 0.99
local unitRatioPenaltyPerUnit = 0.25
