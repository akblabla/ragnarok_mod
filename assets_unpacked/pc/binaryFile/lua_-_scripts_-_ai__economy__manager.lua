...
function AIEconomyManager.init()
	Ragnarok.addAction(AIEconomyManager.setup,"start_of_game",true)
...
function AIEconomyManager.setup(context)
	for i, unit in pairs(Wargroove.getUnitsAtLocation()) do
		Wargroove.setAIRestriction(unit.id, "cant_recruit",true)
	end
end
