...
function Ragnarok.removeCrown()
	...
	print(dump(crown,0))
	if crown ~= nil then
		print("deleting ground crown" )
        Wargroove.removeUnit(crown.id)
        Wargroove.clearCaches()
		Wargroove.waitFrame()
		print("deleting ground crown end" )
	end
	local crownBearer = Ragnarok.getCrownBearer()
	print("crownBearer" )
	print(dump(crownBearer,0))
	if crownBearer ~= nil then
		print("deleting unit crown" )
		...
		Wargroove.updateUnit(crownBearer)
		Wargroove.waitFrame()
		print("deleting unit crown end" )
	end
	Ragnarok.crownID = nil
	Ragnarok.crownBearerID = nil
	print("Ragnarok.removeCrown() end")
end

function Ragnarok.dropCrown(targetPos)
	print("Ragnarok.dropCrown(targetPos)")
...
--	Wargroove.spawnUnitEffect(Ragnarok.crownID, crownOffsetAnimation, "idle", nil, true, false)
	...
	Ragnarok.crownBearerID = nil
	print("Ragnarok.dropCrown(targetPos) end")
end
